...
| `macos` | Finder, Dock, keyboard, trackpad, screenshots, display sleep (10 min on battery, never on AC), firewall, Safari develop menu, Firefox as default browser; ComputerName / HostName / LocalHostName |
