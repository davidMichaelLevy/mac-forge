...
Default apps from the Brewfile include Ghostty, Rectangle, Raycast, Cursor, VS Code, Firefox, Chrome, 1Password, IINA, Stats, and Keka. Edit the file before the first run if you want a leaner machine.
